...
<%@include file="/WEB-INF/views/header.jsp"%>
	...
	<div class="container">
			...
			<div class="col-xs-9">
				<div id="the-slider" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="item">
							<img
								src="<c:url value="/resources/img/moto360slide1.jpg" />"
								alt=" ">
						</div>
						<!---item2--->
						...
						<div class="item">
							<img
								src="<c:url value="/resources/img/fitbitslide.jpg" />"
								alt=" ">
						</div>

						<div class="item">
							<img
								src="<c:url value="/resources/img/alcatelslide.jpg" />"
								alt=" ">
						</div>
						<!---item3--->
			...
			<div class="col-xs-3 ">
				<p>
					<a href="motobrand"><img class="img-responsive"
						src="<c:url value="/resources/img/motobrand.jpg" />"
						alt=" "></a>
				</p>
			</div>
		...
		<div class="row">
		<div class="col-xs-12">
		<a href="#" align="center"><img src="<c:url value="/resources/img/wearable.png" />"style="width:100%"></a>
		</div>
		</div>
		<hr>
				<h1>
